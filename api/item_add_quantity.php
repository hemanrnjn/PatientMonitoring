...
$item_add_quantity = $request->item_add_qty;
$item_add_details = $request->item_add_details;
...
$sql = "UPDATE item_table SET `$item_warehouse_id` = `$item_warehouse_id` + '$item_add_quantity' WHERE item_name = '$item_name' AND item_hsn_sac = '$item_hsn_sac'";
...
VALUES ('$item_name', '$item_type', '$item_hsn_sac', '$item_add_quantity', '$item_rate', '$item_min_sellingprice', '$item_purchasingprice', '$item_tax', 0, 'purchased', '$item_warehouse_id', '$item_add_details')";
